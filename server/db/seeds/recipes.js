  ...
  return knex('recipes').del()
    .then(function () {
      ...
      return knex('recipes').insert([
        ...
        { id: 5, name: 'Eggs and chips', description: 'Cut potatoes into the shape of wedges and place in oven for 20 minutes at 200 degrees celcious until golden brown, fry 2 eggs in a frying pan until cooked, place on plate with the chips and add a tin of baked beans if desired. ', ingredients: JSON.stringify(['4 large potatoes', '2 eggs', '1 tin of baked beans']), img: 'public/images/eggs-and-chips.jpg', category: 'Grains' },
        ...
        { id: 7, name: 'Eggs and chips', description: 'Cut potatoes into the shape of wedges and place in oven for 20 minutes at 200 degrees celcious until golden brown, fry 2 eggs in a frying pan until cooked, place on plate with the chips and add a tin of baked beans if desired. ', ingredients: JSON.stringify(['4 large potatoes', '2 eggs', '1 tin of baked beans']), img: 'public/images/eggs-and-chips.jpg', category: 'Vegetables' },
